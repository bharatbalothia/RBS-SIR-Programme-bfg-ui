...
export const TOOLTIP_CONTENT: TooltipContent = {
    ...
    'entity.scl-schedule.type.create': 'Window or Daily. ',
    'entity.scl-schedule.timeStart.create': 'If window is used then start time and end time must be specified. If Daily then only start time is specified',
    'entity.scl-schedule.windowEnd.create': 'Used if type is Window to indicate the end of the window.',
    'entity.scl-schedule.windowInterval.create': 'If Window is used it is the time windowInterval to start the bulking process.',
    'entity.scl-schedule.filetype.create': 'Currently this is limited to ICF and QCF files',
    'entity.scl-mqdetails.mqHost.create': 'The Puma MQ Host name',
    'entity.scl-mqdetails.mqPort.create': 'The Puma MQ port number',
    'entity.scl-mqdetails.mqQManager.create': 'The Puma MQ Queue Manager',
    'entity.scl-mqdetails.mqChannel.create': 'The Puma MQ Channel name',
    'entity.scl-mqdetails.mqQueueName.create': 'The Puma MQ Queue name',
    'entity.scl-mqdetails.mqQueueBinding.create': 'The Puma MQ  binding mode. Normally ASQDEF',
    'entity.scl-mqdetails.mqQueueContext.create': 'The Puma MQ  context. Normally NONE',
    'entity.scl-mqdetails.mqDebug.create': 'The Puma MQ Debug.Normally No',
    'entity.scl-mqdetails.mqSSLOptions.create': 'The Puma MQ Encryption. Normally SSL_MUST',
    'entity.scl-mqdetails.mqSSLCiphers.create': 'The Puma MQ Cipher. The MQ team will specify the allowed ciphers.',
    'entity.scl-mqdetails.mqSSLKeyCert.create': 'The Puma MQ Certificate that identities the Sterling Integrator MQ client. Update this if our certificate is renewed/updated.',
    'entity.scl-mqdetails.mqSSLCaCert.create': 'The Puma MQ the CA Root certificate if the CA that signs the Queue Manager certificate. Change this if the remote system updates their signing Authority.',
    'entity.scl-mqdetails.mqHeader.create': 'The header included in the MQ message. PUMA will define this.',
    'entity.scl-mqdetails.mqSessionTimeout.create': 'The Puma MQ timeout.',
    ...
    'entity.scl-schedule.type.edit': 'Window or Daily. ',
    'entity.scl-schedule.timeStart.edit': 'If window is used then start time and end time must be specified. If Daily then only start time is specified',
    'entity.scl-schedule.windowEnd.edit': 'Used if type is Window to indicate the end of the window.',
    'entity.scl-schedule.windowInterval.edit': 'If Window is used it is the time windowInterval to start the bulking process.',
    'entity.scl-schedule.filetype.edit': 'Currently this is limited to ICF and QCF files',
    'entity.scl-mqdetails.mqHost.edit': 'The Puma MQ Host name',
    'entity.scl-mqdetails.mqPort.edit': 'The Puma MQ port number',
    'entity.scl-mqdetails.mqQManager.edit': 'The Puma MQ Queue Manager',
    'entity.scl-mqdetails.mqChannel.edit': 'The Puma MQ Channel name',
    'entity.scl-mqdetails.mqQueueName.edit': 'The Puma MQ Queue name',
    'entity.scl-mqdetails.mqQueueBinding.edit': 'The Puma MQ  binding mode. Normally ASQDEF',
    'entity.scl-mqdetails.mqQueueContext.edit': 'The Puma MQ  context. Normally NONE',
    'entity.scl-mqdetails.mqDebug.edit': 'The Puma MQ Debug.Normally No',
    'entity.scl-mqdetails.mqSSLOptions.edit': 'The Puma MQ Encryption. Normally SSL_MUST',
    'entity.scl-mqdetails.mqSSLCiphers.edit': 'The Puma MQ Cipher. The MQ team will specify the allowed ciphers.',
    'entity.scl-mqdetails.mqSSLKeyCert.edit': 'The Puma MQ Certificate that identities the Sterling Integrator MQ client. Update this if our certificate is renewed/updated.',
    'entity.scl-mqdetails.mqSSLCaCert.edit': 'The Puma MQ the CA Root certificate if the CA that signs the Queue Manager certificate. Change this if the remote system updates their signing Authority.',
    'entity.scl-mqdetails.mqHeader.edit': 'The header included in the MQ message. PUMA will define this.',
    'entity.scl-mqdetails.mqSessionTimeout.edit': 'The Puma MQ timeout.',
