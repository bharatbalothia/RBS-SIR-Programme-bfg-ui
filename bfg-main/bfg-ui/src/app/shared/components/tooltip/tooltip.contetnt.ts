...
export const TOOLTIP_CONTENT: TooltipContent = {
    ...
    'file-search.search.filename.search': 'Enter a filename to find matching files',
    'file-search.search.reference.search': 'Enter a reference value to find matching files',
    'file-search.search.type.search': 'Select to find files with a specific type',
    'file-search.search.from.search': 'Select to find files processed from a particular date/time',
    ...
    'sct-search.search.reference.search': 'Enter a reference to find matching transactions',
    'sct-search.search.trans-id.search': 'Enter a transaction id to find matching transactions',
    'sct-search.search.payment-bic.search': 'Enter a payment BIC to find matching transactions',
    'sct-search.search.type.search': 'Select to find transactions with a specific type',
    'sct-search.search.settlement-from.search': 'Select to find transaction settled from a particular date/time',
    'sct-search.search.settlement-to.search': 'Select to find transaction settled up to a particular date/time',
    'sct-search.search.ptimestamp-from.search': 'Select to find transaction with timestamp from a particular date/time',
