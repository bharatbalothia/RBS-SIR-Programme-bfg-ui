...
public enum EntityErrorCode implements ErrorCode {
    ...
    InvalidUserForUpdateChangeControlException("ENT_INVALID_EDIT_PENDING_USER_CODE", "ENT_INVALID_EDIT_PENDING_USER_MSG", "ENT_INVALID_EDIT_PENDING_STATUS"),
    StatusNotPendingException("ENT_STATUS_NOT_PENDING_CODE", "ENT_STATUS_NOT_PENDING_MSG", "ENT_STATUS_NOT_PENDING_STATUS"),
    StatusPendingException("ENT_STATUS_PENDING_CODE", "ENT_STATUS_PENDING_MSG", "ENT_STATUS_PENDING_STATUS"),
    ...
    InvalidEventException("ENT_AUDIT_FAIL_CODE", "ENT_AUDIT_FAIL_MSG", "ENT_AUDIT_FAIL_STATUS"),
