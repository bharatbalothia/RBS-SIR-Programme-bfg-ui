...
--------------------------------------------------------
  ...
  CREATE SEQUENCE "$$TBLUSER$$"."SCT_ENTITY_IDSEQ"
  MINVALUE 1
...
CREATE TABLE "$$TBLUSER$$"."SCT_ENTITY"
  (
                "ENTITY_ID" NUMBER(*,0),
...
--------------------------------------------------------
  ...
  CREATE TABLE "$$TBLUSER$$"."SFG_CHANGE_CONTROL"
  (
...
--------------------------------------------------------
  ...
  CREATE SEQUENCE "$$TBLUSER$$"."SCT_SCHEDULE_IDSEQ"
  MINVALUE 1
...
CREATE TABLE "$$TBLUSER$$"."SCT_SCHEDULE"
  (
...
--------------------------------------------------------
  ...
  CREATE SEQUENCE "$$TBLUSER$$"."SCT_BUNDLE_IDSEQ"
  MINVALUE 1
  MAXVALUE 9999999999999999999999999
  INCREMENT BY 1
  START WITH 142765
...
CREATE TABLE "$$TBLUSER$$"."SCT_BUNDLE"
  (
               "BUNDLE_ID" NUMBER(*,0),
...
--------------------------------------------------------
  ...
  CREATE SEQUENCE "$$TBLUSER$$"."SCT_PAYMENT_IDSEQ"
  MINVALUE 1
  MAXVALUE 9999999999999999999999
  INCREMENT BY 1
  START WITH 3313163
...
CREATE TABLE "$$TBLUSER$$"."SCT_PAYMENT"
  (
               "PAYMENT_ID" NUMBER(*,0),
               "MESSAGE_ID" NUMBER(*,0),
               "WF_ID" NUMBER(*,0),
...
CREATE TABLE "$$TBLUSER$$"."SCT_PAYMENT_ARCHIVE"
  (
               "PAYMENT_ID" NUMBER(*,0),
               "MESSAGE_ID" NUMBER(*,0),
               "WF_ID" NUMBER(*,0),
...
--------------------------------------------------------
  ...
  ALTER TABLE "$$TBLUSER$$"."SFG_CHANGE_CONTROL"
    MODIFY ("CHANGE_DATE" NOT NULL ENABLE);
  ALTER TABLE "$$TBLUSER$$"."SFG_CHANGE_CONTROL"
    MODIFY ("CHANGE_USER" NOT NULL ENABLE);
  ALTER TABLE "$$TBLUSER$$"."SFG_CHANGE_CONTROL"
    MODIFY ("STATUS" NOT NULL ENABLE);
  ALTER TABLE "$$TBLUSER$$"."SFG_CHANGE_CONTROL"
    MODIFY ("OPERATION" NOT NULL ENABLE);
  ALTER TABLE "$$TBLUSER$$"."SFG_CHANGE_CONTROL"
    MODIFY ("CHANGE_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SCT_BUNDLE
--------------------------------------------------------

  ALTER TABLE "$$TBLUSER$$"."SCT_BUNDLE"
    ADD CONSTRAINT "SCT_BUNDLE_C02" CHECK (ISOVERRIDE IN (0,1)) ENABLE;
  ALTER TABLE "$$TBLUSER$$"."SCT_BUNDLE"
    ADD CONSTRAINT "SCT_BUNDLE_PK" PRIMARY KEY ("BUNDLE_ID") USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS
        STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645 PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT) TABLESPACE "$$TBLSPACE$$"  ENABLE;
  ALTER TABLE "$$TBLUSER$$"."SCT_BUNDLE"
    ADD CONSTRAINT "SCT_BUNDLE_C01" CHECK (ISOUTBOUND IN (0,1,2)) ENABLE;
  ALTER TABLE "$$TBLUSER$$"."SCT_BUNDLE"
    MODIFY ("SERVICE" NOT NULL ENABLE);
  ALTER TABLE "$$TBLUSER$$"."SCT_BUNDLE"
    MODIFY ("ISOVERRIDE" NOT NULL ENABLE);
  ALTER TABLE "$$TBLUSER$$"."SCT_BUNDLE"
    MODIFY ("ISOUTBOUND" NOT NULL ENABLE);
  ALTER TABLE "$$TBLUSER$$"."SCT_BUNDLE"
    MODIFY ("STATUS" NOT NULL ENABLE);
  ALTER TABLE "$$TBLUSER$$"."SCT_BUNDLE"
    MODIFY ("BUNDLE_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SCT_ENTITY
--------------------------------------------------------

  ALTER TABLE "$$TBLUSER$$"."SCT_ENTITY"
    ADD CONSTRAINT "SCT_ENTITY_C01" CHECK (SNF IN (0,1)) ENABLE;
  ALTER TABLE "$$TBLUSER$$"."SCT_ENTITY"
    ADD CONSTRAINT "SCT_ENTITY_C02" CHECK (TRACE IN (0,1)) ENABLE;
  ALTER TABLE "$$TBLUSER$$"."SCT_ENTITY"
    ADD CONSTRAINT "SCT_ENTITY_C03" CHECK (DELIVERYNOTIF IN (0,1)) ENABLE;
  ALTER TABLE "$$TBLUSER$$"."SCT_ENTITY"
    ADD CONSTRAINT "SCT_ENTITY_C04" CHECK (ISDELETED in (0,1)) ENABLE;
  ALTER TABLE "$$TBLUSER$$"."SCT_ENTITY"
    ADD CONSTRAINT "SCT_ENTITY_PK" PRIMARY KEY ("ENTITY_ID") USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645 PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT) TABLESPACE "$$TBLSPACE$$"  ENABLE;
  ALTER TABLE "$$TBLUSER$$"."SCT_ENTITY"
    ADD CONSTRAINT "SCT_ENTITY_U01" UNIQUE ("MQQUEUEOUT") USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645 PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT) TABLESPACE "$$TBLSPACE$$"  ENABLE;
  ALTER TABLE "$$TBLUSER$$"."SCT_ENTITY"
    ADD CONSTRAINT "SCT_ENTITY_U02" UNIQUE ("MAILBOXPATHOUT") USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645 PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT) TABLESPACE "$$TBLSPACE$$"  ENABLE;
  ALTER TABLE "$$TBLUSER$$"."SCT_ENTITY"
    ADD CONSTRAINT "SCT_ENTITY_U03" UNIQUE ("ENTITY", "SERVICE") USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645 PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT) TABLESPACE "$$TBLSPACE$$"  ENABLE;
  ALTER TABLE "$$TBLUSER$$"."SCT_ENTITY"
  ...
  ALTER TABLE "$$TBLUSER$$"."SCT_ENTITY"
    MODIFY ("ENTITY_ID" NOT NULL ENABLE);

--------------------------------------------------------
--  Constraints for Table SCT_PAYMENT
--------------------------------------------------------

  ALTER TABLE "$$TBLUSER$$"."SCT_PAYMENT"
    ADD CONSTRAINT "SCT_PAYMENT_PK" PRIMARY KEY ("PAYMENT_ID") USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645 PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT) TABLESPACE "$$TBLSPACE$$"  ENABLE;
  ALTER TABLE "$$TBLUSER$$"."SCT_PAYMENT"
    ADD CONSTRAINT "SCT_PAYMENT_U01" UNIQUE ("MESSAGE_ID") USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645 PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT) TABLESPACE "$$TBLSPACE$$"  ENABLE;
  ALTER TABLE "$$TBLUSER$$"."SCT_PAYMENT"
    ADD CONSTRAINT "SCT_PAYMENT_C01" CHECK (ISOUTBOUND IN (0,1,2)) ENABLE;
  ALTER TABLE "$$TBLUSER$$"."SCT_PAYMENT"
    MODIFY ("ISOUTBOUND" NOT NULL ENABLE);
  ALTER TABLE "$$TBLUSER$$"."SCT_PAYMENT"
    MODIFY ("STATUS" NOT NULL ENABLE);
  ALTER TABLE "$$TBLUSER$$"."SCT_PAYMENT"
    MODIFY ("PAYMENT_ID" NOT NULL ENABLE);

--------------------------------------------------------
--  Constraints for Table SCT_PAYMENT_ARCHIVE
--------------------------------------------------------

  ALTER TABLE "$$TBLUSER$$"."SCT_PAYMENT_ARCHIVE"
    ADD CONSTRAINT "SCT_PAYMENT_A_C01" CHECK (ISOUTBOUND IN (0,1,2)) ENABLE;
  ALTER TABLE "$$TBLUSER$$"."SCT_PAYMENT_ARCHIVE"
    ADD CONSTRAINT "SCT_PAYMENT_A_PK" PRIMARY KEY ("PAYMENT_ID") USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645 PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT) TABLESPACE "$$TBLSPACE$$"  ENABLE;
  ALTER TABLE "$$TBLUSER$$"."SCT_PAYMENT_ARCHIVE"
    ADD CONSTRAINT "SCT_PAYMENT_A_U01" UNIQUE ("MESSAGE_ID") USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645 PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT) TABLESPACE "$$TBLSPACE$$"  ENABLE;
  ALTER TABLE "$$TBLUSER$$"."SCT_PAYMENT_ARCHIVE"
    MODIFY ("ISOUTBOUND" NOT NULL ENABLE);
  ALTER TABLE "$$TBLUSER$$"."SCT_PAYMENT_ARCHIVE"
    MODIFY ("STATUS" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "$$TBLUSER$$"."SCT_SCHEDULE"
    ADD CONSTRAINT "SCT_SCHEDULE_C01" CHECK (ACTIVE IN (0,1)) ENABLE;
  ALTER TABLE "$$TBLUSER$$"."SCT_SCHEDULE"
    ADD CONSTRAINT "SCT_SCHEDULE_PK" PRIMARY KEY ("SCHEDULE_ID") USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645 PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT) TABLESPACE "$$TBLSPACE$$"  ENABLE;
  ALTER TABLE "$$TBLUSER$$"."SCT_SCHEDULE"
    MODIFY ("ACTIVE" NOT NULL ENABLE);
  ALTER TABLE "$$TBLUSER$$"."SCT_SCHEDULE"
    MODIFY ("ISWINDOW" NOT NULL ENABLE);
  ALTER TABLE "$$TBLUSER$$"."SCT_SCHEDULE"
    MODIFY ("ENTITY_ID" NOT NULL ENABLE);
  ALTER TABLE "$$TBLUSER$$"."SCT_SCHEDULE"
    MODIFY ("SCHEDULE_ID" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "$$TBLUSER$$"."SCT_BUNDLE"
    ADD CONSTRAINT "SCT_BUNDLE_F01" FOREIGN KEY ("ENTITY_ID") REFERENCES "$$TBLUSER$$"."SCT_ENTITY" ("ENTITY_ID") ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "$$TBLUSER$$"."SCT_PAYMENT"
    ADD CONSTRAINT "SCT_PAYMENT_F01" FOREIGN KEY ("BUNDLE_ID") REFERENCES "$$TBLUSER$$"."SCT_BUNDLE" ("BUNDLE_ID") ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "$$TBLUSER$$"."SCT_SCHEDULE"
    ADD CONSTRAINT "SCT_SCHEDULE_F01" FOREIGN KEY ("ENTITY_ID") REFERENCES "$$TBLUSER$$"."SCT_ENTITY" ("ENTITY_ID") ENABLE;
    
--------------------------------------------------------
--  DDL for Trigger SCT_PAYMENT_NEWID
--------------------------------------------------------

CREATE OR REPLACE TRIGGER "$$TBLUSER$$"."SCT_PAYMENT_NEWID"
    BEFORE INSERT
...
ALTER TRIGGER "$$TBLUSER$$"."SCT_PAYMENT_NEWID" ENABLE;
