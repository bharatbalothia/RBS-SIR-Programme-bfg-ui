...
public class CertificateExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        ErrorMessage errorMessage =
                errorMessageHandler.getErrorMessage(CertificateErrorCode.METHOD_ARGUMENT_NOT_VALID_EXCEPTION, errors);
    ...
    protected ResponseEntity<Object> handleMissingServletRequestParameter(
        ...
        ErrorMessage errorMessage =
                errorMessageHandler.getErrorMessage(CertificateErrorCode.METHOD_MISSING_ARGUMENT_EXCEPTION,
    ...
    public ResponseEntity<Object> handleMethodArgumentTypeMismatch(
        ...
        ErrorMessage errorMessage =
                errorMessageHandler.getErrorMessage(CertificateErrorCode.METHOD_ARGUMENT_TYPE_MISMATCH_EXCEPTION,
    ...
    public ResponseEntity<ErrorMessage> handleAll(Throwable ex) {
        ...
        if (Arrays.stream(CertificateErrorCode.values()).anyMatch(value -> value.name().equals(testErrorName)))
            errorMessage = errorMessageHandler.getErrorMessage(CertificateErrorCode.valueOf(errorName));
        else
            errorMessage = errorMessageHandler.getErrorMessage(CertificateErrorCode.FAIL,
